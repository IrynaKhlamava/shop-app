...
import static com.example.authservice.exception.AppMessages.ACCESS_DENIED;
import static com.example.authservice.exception.AppMessages.ACCESS_DENIED_TITLE;
import static com.example.authservice.exception.AppMessages.CUSTOM_ERROR_TITLE;
import static com.example.authservice.exception.AppMessages.UNEXPECTED_ERROR_TITLE;
import static com.example.authservice.exception.AppMessages.VALIDATION_ERROR_TITLE;
